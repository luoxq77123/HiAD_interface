...
class AppAction extends CAction {
    ...
    public function run() {
        ...
        $controller->renderPartial('app', $set);
    }
    ...
    public function initParams() {
        ...
        // 统计时间选择参数
        $params['timePeriods'] = AppStatistics::model()->timePeriodsParams();
    ...
    public function getStatisticsInfo() {
        ...
        // 根据条件获取统计数据
        $statisticsData = AppStatistics::model()->getStatisticsByDate($params['type'], $params['typeid'], $params['startDate'], $params['endDate']);
