...
class SiteAdLanguage extends CActiveRecord {
    ...
    public function getDataByName($name = null) {
        $cache_name = md5('model_SiteAdLanguage_getDataByName_'.$name);
    ...
    public function getList() {
        $cache_name = md5('model_SiteAdLanguage_getList');
