...
$(function() {
	$.fn.manhua_hoverTips = function(options) {
		...
		var $this = $(this);
		$("body").prepend('<div class="docBubble" id="btip'+bid+'"><i class="triangle-'+options.position+'"></i><div class="tl"><div class="inner"><div class="box_hoverTips"><div class="box_top_hoverTips"><span><var></var></span></div> <div class="tips_cont"></div> <div class="box_bottom_hoverTips"><span><var></var></span></div></div></div></div><div class="tr"></div><div class="bl"></div></div>');
		var $btip = $("#btip"+bid);
		...
		$this.die().live("mousemove",function(){
			...
			switch(options.position){
				...
				case "l" ://当它是左边的时候		
					...
					$btip.css({ "left":offset.left+w  ,  "top":offset.top+h/2-options.value }).show();
					break;
				case "r" ://当它是右边的时候			
