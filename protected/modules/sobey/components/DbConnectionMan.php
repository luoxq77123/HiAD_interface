    ...
    public function getSlave() {
        if (!isset($this->_slave)) {
            ...
            foreach ($this->slaves as $slaveConfig) {
                ...
                $slaveConfig['charset'] = isset($slaveConfig['charset']) ? $slaveConfig['charset'] : $this->charset;
                $slaveConfig['tablePrefix'] = isset($slaveConfig['tablePrefix']) ? $slaveConfig['tablePrefix'] : $this->tablePrefix;
                $slaveConfig['emulatePrepare'] = isset($slaveConfig['emulatePrepare']) ? $slaveConfig['emulatePrepare'] : $this->emulatePrepare;
                $slaveConfig['schemaCachingDuration'] = isset($slaveConfig['schemaCachingDuration']) ? $slaveConfig['schemaCachingDuration'] : $this->schemaCachingDuration;
