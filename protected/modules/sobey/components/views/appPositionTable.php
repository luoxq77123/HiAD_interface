...
<div class="right font12" id="info_nav_box">
    <div class="taskbar">
        <div class="line line3"> 
            <a href="<?php echo Yii::app()->createUrl('appPosition/index');?>" style="float:left;margin-left: 20px;" class="load_frame">&lt;&lt;返回广告位列表</a>
        ...
        <div class="timetable">
                            ...
                            <td style="width:281px">
                                <div class="date"> 
                                    <?php if ($now_year < $this_year): ?>
                                        <a href="<?php echo Yii::app()->createUrl('appPosition/table', array('ym' => ($this_year - 1) . $this_month) + $_GET); ?>" area="ggw_box" class="load_frame turnL fl"><?php echo ($this_year - 1); ?></a>
                                    <?php endif; ?>
                                    <a href="<?php echo Yii::app()->createUrl('appPosition/table', array('ym' => ($this_year + 1) . $this_month) + $_GET); ?>" area="ggw_box" class="load_frame turnR fr"><?php echo ($this_year + 1); ?></a>
                                    <?php
                                    $y_m_s = array();
            ...
            <div style="margin-left: 282px;" class="timetable_list">
                <div class="schedule-list">
                    <table class="weektable" id="weektable" style="width:810px;" >
                    <!-- border="0" cellspacing="0" cellpadding="0" border-left: 1px solid #ccc  -->
                        <thead>
                            <tr>
                                <td class=" monthTurn month" colspan="32">
                                    <?php if ($now_year < $this_year || ($now_year == $this_year && $now_month < $this_month)): ?>
                                        <a href="<?php echo Yii::app()->createUrl('appPosition/table', array('ym' => date('Ym', strtotime('-1 month', $start_timestamp))) + $_GET); ?>" area="ggw_box" class="load_frame turnL fl">上一月</a>
                                    <?php endif; ?>
                                    <a href="<?php echo Yii::app()->createUrl('appPosition/table', array('ym' => date('Ym', strtotime('+1 month', $start_timestamp))) + $_GET); ?>" area="ggw_box" class="load_frame turnR fr">下一月</a>
                            ...
                            <tr class="cell">
                                ...
                                <?php while ($first <= $last_day): ?>
                                    ...
                                    ?>
                                    <td class="<?php echo $class; ?>"><?php echo $day_name; 
									?></td>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#year_month_select').change(function(){
            var url = '<?php echo Yii::app()->createUrl('appPosition/table', $get); ?>&ym=' + $('#year_month_select option:selected').val();
