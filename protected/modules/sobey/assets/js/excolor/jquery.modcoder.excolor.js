...
jQuery.fn.modcoder_excolor = function(C) {
    ...
    return this.each(function() {
        ...
        jQuery(aitem).clone().show().addClass('mds' + A).css('position', 'absolute').css('visibility', 'hidden').appendTo(jQuery(aitem).parent().parent());
        setTimeout(function() {
            var a = jQuery('.mds' + A);
        ...
        function run_modcoder_colorpicker() {
            ...
            switcher = jQuery('div#modcoder_switcher');
            slider = jQuery('div#modcoder_slider');
            sb_sel = jQuery('div#modcoder_picker');
            switch (C.effect) {
            case 'zoom':
                ...
                function() {
                    jQuery(this).show();
                    jQuery('div#modcoder_slider, div#modcoder_picker').show();
            ...
            case 'slide':
                ...
                break;
            case 'fade':
                jQuery('div#modcoder_colorpicker, div#modcoder_slider, div#modcoder_picker, div#modcoder_switcher').fadeTo(1, 0,
                function() {
        ...
        jQuery(aitem).click(function() {
            if (!opened) {
                jQuery('div#modcoder_slider, div#modcoder_picker, div#modcoder_colorpicker').stop().remove();
                setTimeout(function() {
