...
class MaterialPic extends CActiveRecord {
    ...
    public function getByMaterialPic($materialPic_id) {
        $pic_id = explode(",",$materialPic_id);
        $criteria = new CDbCriteria();
        //$criteria->select = 'id,ad_id,cushion,com_id,uid,width,height,pos_x,pos_y,material';
        $criteria->addInCondition('material_id', $pic_id);
        $materialPic = $this->findAll($criteria);
        $return = array();
