...
class SiteStatListWidget extends CWidget {
    // 获取内容地址
    public $route;
    // 设置每页条数限制组
    public $arrPageSize;
    ...
    public function getStatisticsInfo() {
        ...
        // 根据条件获取统计数据
        $statisticsData = SiteStatistics::model()->getPageListByType($params['type'], $params['typeid'], $params['startDate'], $params['endDate'], $this->route);
        // 组合数据
